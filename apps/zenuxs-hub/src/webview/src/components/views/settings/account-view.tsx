...
async function fetchAccountUser(): Promise<ZenuxsAccountUser> {
	return await desktopClient.invoke<ZenuxsAccountUser>("cline_account", {
		action: "clineAccount",
		operation: "fetchMe",
	});
}

async function fetchAccountBalance(): Promise<ZenuxsAccountBalance> {
	return await desktopClient.invoke<ZenuxsAccountBalance>("cline_account", {
		action: "clineAccount",
...
async function fetchAccountOrganizations(): Promise<
	ZenuxsAccountOrganization[]
> {
	return await desktopClient.invoke<ZenuxsAccountOrganization[]>(
		"cline_account",
		{
			action: "clineAccount",
...
async function fetchOrganizationBalance(
	...
	return await desktopClient.invoke<ZenuxsAccountOrganizationBalance>(
		"cline_account",
		{
			action: "clineAccount",
...
async function fetchUsageTransactions(): Promise<
	ZenuxsAccountUsageTransaction[]
> {
	return await desktopClient.invoke<ZenuxsAccountUsageTransaction[]>(
		"cline_account",
		{
			action: "clineAccount",
...
async function fetchOrganizationUsageTransactions(
	...
	return await desktopClient.invoke<ZenuxsAccountOrganizationUsageTransaction[]>(
		"cline_account",
		{
			action: "clineAccount",
...
async function fetchPaymentTransactions(): Promise<
	ZenuxsAccountPaymentTransaction[]
> {
	return await desktopClient.invoke<ZenuxsAccountPaymentTransaction[]>(
		"cline_account",
		{
			action: "clineAccount",
...
export function AccountView() {
	...
	// Overview data
	const [user, setUser] = useState<ZenuxsAccountUser | null>(null);
	const [balance, setBalance] = useState<ZenuxsAccountBalance | null>(null);
	const [organizationBalance, setOrganizationBalance] =
		useState<ZenuxsAccountOrganizationBalance | null>(null);
