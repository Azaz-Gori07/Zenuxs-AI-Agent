	...
	},
{
    ...
    capabilities: ["tools"],
    defaultModelId: "gpt-4o",
    modelsSourceUrl: "https://aiapi.zenuxs.in/api/zenuxs-code/ai-models",
	...
	},
	{
		...
		description: "Cloudflare AI Gateway for model routing and caching",
		family: "openai-compatible",
		capabilities: ["tools", "reasoning"],
		defaultModelId: "openai/gpt-4o",
		apiKeyEnv: ["CLOUDFLARE_API_TOKEN", "CF_AIG_TOKEN"],
		defaults: { baseUrl: "https://gateway.ai.cloudflare.com/v1" },
	},
	{
		...
		family: "openai-compatible",
		capabilities: ["tools"],
		apiKeyEnv: ["CLOUDFLARE_API_KEY", "CLOUDFLARE_WORKERS_AI_TOKEN"],
		defaults: { baseUrl: "https://api.cloudflare.com/client/v4/accounts" },
	},
	{
		id: "github-copilot",
		name: "GitHub Copilot",
		description: "GitHub Copilot code completion and chat models",
		family: "openai-compatible",
		capabilities: ["tools", "reasoning"],
		defaultModelId: "gpt-4o-copilot",
		apiKeyEnv: ["GITHUB_COPILOT_API_KEY", "GH_COPILOT_API_KEY"],
		defaults: {},
	},
	{
		id: "mybackup",
