...
import type { ZenuxsCoreStartInput } from "./types";

export function toZenuxsCoreStartInput(
	...
	return "providerId" in config
		...
		: (input as ZenuxsCoreStartInput);
}

export interface NormalizeZenuxsCoreStartInputOptions {
...
export function normalizeZenuxsCoreStartInput(
	input: ZenuxsCoreStartInput,
	options: NormalizeZenuxsCoreStartInputOptions = {},
): StartSessionInput {
